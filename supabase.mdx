---
title: "Supabase"
description: "Connect Supabase to your Tile.dev app for a scalable, production-ready backend"
---

Supabase is an open-source alternative to Firebase that provides a hosted PostgreSQL database with real-time capabilities, user authentication and serverless functions. When you connect Supabase to your Tile.dev app, you instantly gain a scalable, production-ready backend without writing boilerplate code or configuring servers. Best of all, our dedicated Supabase Agent seamlessly handles the integration between your backend and your Tile.dev app.
...
4. Tile.dev will automatically configure the connection and you will get project's details on your screen.
...
Tile.dev will:
* Generate the contact form UI
* Create a Supabase table for storing submissions
* Connect the form to the database automatically

<Tip>
To use Supabase in your first prompt, follow these steps:
* Ask the Agent to generate a "Blank App"
* Connect to Supabase
* Then provide your actual prompt
</Tip>

## Adding User Authentication via Supabase
...
You can test user signups via:
* The new login form in your app
* Supabase Dashboard > Authentication > Users

<Tip>
Disable email confirmation while testing:
* Go to Supabase Dashboard > Auth > Settings > Email
